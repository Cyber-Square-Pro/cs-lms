  ...
  const logo =
    ...
    const menuItems = [
...

        {
          group: "Academics",
          children: [
            { label: "View Notes", href: "/student/notes", icon: Notebook },
            { label: "Leave letter", href: "/teacher/academic/notes/view", icon: Eye },
          ],
        },
...

        {
          group: "Settings",
          children: [
            { label: "Change Password", href: "/student/password/change", icon: Notebook },
            { label: "Logout", href: "/teacher/settings/password/change", icon: LogOut },
